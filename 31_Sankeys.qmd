...
#load basins excretions and merge 2 files
file_human_excretions <- bind_rows(
  file_human_excretions,
  read_csv(paste0(path_source, "excretions_human_basins_kt_year.csv"))
)  

#large industries network discharge
path_source <- "output_data/industry_network_discharge/"
file_industry_discharge <- read_csv(paste0(path_source, "industry_network_discharge_GEREP_basins.csv"))
file_industry_discharge <- file_industry_discharge %>% #mean of the 2015-2020 period
...
#inflow and outflows of WWTP, by basin
path_source <- "output_data/0_final_data/"
file_in_out_flows <- read_csv(paste0(path_source, "basins_flows_2015_2020.csv"))

#discharged without treatment (% as share of pollution entering WWTP)
path_source <- "source_data/10_discharge_without_treatment/"
file_direct_discharge <- read_csv(paste0(path_source, "discharge_without_treatment_estimations.csv"))

#connection to sewer networks
path_source <- "source_data/pop_sewage_connection/"
...
#N:P ratio of sludge
path_source <- "output_data/sludge_composition/"
...
#proportion of people in IAS to sewers (due to excretions in public spaces connected to sewers)
perc_non_IAS <- 0.33
```
...
# Sankeys P {.tabset .tabset-fade .tabset-pills}
...
## Artois-Picardie {.tabset .tabset-fade}
...
## Seine-Normandie {.tabset .tabset-fade}
...
## Loire-Bretagne {.tabset .tabset-fade}
...
## Adour-Garonne {.tabset .tabset-fade}
...
## Rhône-Méditerranée-Corse {.tabset .tabset-fade}
...
# Sankeys N {.tabset .tabset-fade .tabset-pills}
...
## Per capita values {.tabset .tabset-fade .tabset-pills}

### Excretions {.tabset .tabset-fade}
...
### In and out of system {.tabset .tabset-fade}
...
## Recycling {.tabset .tabset-fade .tabset-pills}
...
## Sankey in / out system {.tabset .tabset-fade .tabset-pills}

### Per cap per year {.tabset .tabset-fade}
...
# Comparison of sludge composition {.tabset .tabset-fade .tabset-pills}
