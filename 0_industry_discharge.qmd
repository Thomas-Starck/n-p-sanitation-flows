...
This page describes the data used to determine how much nitrogen and phosphorus is discharges by industries to sewers networks.
...
We also create a file with the flows of all the facilities
